...
resource "linode_firewall" "nats_firewall" {                                                                                                                                           
  ...
  inbound {                                                                                                                                                                            
    ...
    action   = "ACCEPT"                                                                                                                                                                
    protocol = "TCP"                                                                                                                                                                   
    ports    = "6222, 1883, 1880, 8883, 8443"                                                                                                                                          
...
//      "docker run -d --restart always --add-host host.docker.internal:172.17.0.1 --name edge-trader -m 512m -v app-vol:/data -v /tmp/db:/db -v /etc:/certs -p 443:443 brianapley/edge
-trader",                                                                                                                                                                              
//      "docker run -d --restart always --name node-http -m 512m -v /tmp/db:/tmp/db -v /etc:/etc -p 8443:8443 brianapley/node-http",                                                   
      ...
      "echo '  docker run -d --restart always --add-host host.docker.internal:172.17.0.1 --name edge-trader -m 512m -v app-vol:/data -v /tmp/db:/db -v /etc:/certs -p 443:443 brianaple
y/edge-trader' >> /root/start-docker.sh",                                                                                                                                              
      "echo 'fi' >> /root/start-docker.sh",                                                                                                                                            
